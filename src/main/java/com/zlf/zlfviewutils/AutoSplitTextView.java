...
/**
 * 项目名称：net.meyki.app.widget
 * 项目版本：user-4.5.8
 * 创建人：zhaolifeng
 * 创建时间：2017/7/11 0011 11:56
 * 修改人：Administrator
 * 修改时间：2017/7/11 0011 11:56
 * 类描述： 自动排版换行  (字母一行显示不下 就自动换行了   这里强制不让换行)
 * 修改备注：
 */
...
public class AutoSplitTextView extends TextView {
    ...
    /**  实现悬挂缩进
     *   调用方式  autoSplitText(tv, "1、");  autoSplitText(tv, "2、");
     * @param tv
     * @param indent
     * @return
     */

 ...
 * 项目版本：Test
 * 创建人：zhaolifeng
 * 创建时间：2017/7/27 0027 15:37
 * 修改人：Administrator
 * 修改时间：2017/7/27 0027 15:37
 * 类描述：
 * 修改备注：
 */
...
public class SuperTextView extends TextView {
    ...
    private void initAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            bgColorNormal =
                    typedArray.getColor(R.styleable.SuperTextView_bgColorNormal, bgColorNormal);
            bgColorPressed =
                    typedArray.getColor(R.styleable.SuperTextView_bgColorPressed, bgColorNormal);

            bgColorDisable =
                    typedArray.getColor(R.styleable.SuperTextView_bgColorDisable, bgColorNormal);
            strokeColorNormal =
                    typedArray.getColor(R.styleable.SuperTextView_strokeColorNormal, strokeColorNormal);
            strokeColorPressed =
                    typedArray.getColor(R.styleable.SuperTextView_strokeColorPressed, strokeColorNormal);
            strokeColorDisable =
                    typedArray.getColor(R.styleable.SuperTextView_strokeColorDisable, strokeColorNormal);
            typedArray.recycle();
        }
    }
    ...
    public SuperTextView setStrokeColor(@ColorRes int colorId) {
        this.strokeColorNormal = colorId;
        postInvalidate();
        return this;

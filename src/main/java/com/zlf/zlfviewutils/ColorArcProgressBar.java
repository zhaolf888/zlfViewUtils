 ...
 * //        app:back_color="@android:color/darker_gray"
 ...
 //        app app:current_value="688"
 //        app:max_value="1000"
 //        app:string_unit="68.8%"
 //        app:is_need_title="true"
 //        app:string_title="今日步数"
 //        app:total_engle="270"  //弧度大小
            app:start_engle="135"  //起始角度
...
public class ColorArcProgressBar extends View {
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        colors = new int[]{color1, color2, color3, color4, color5, color6,color7, color7};

        sweepAngle = a.getInteger(R.styleable.ColorArcProgressBar_total_engle, 270);
        startAngle=a.getInteger(R.styleable.ColorArcProgressBar_start_engle, 135);
...
//            canvas.drawCircle(centerX, centerY ,100,vTextPaint);//字的背景圆
     ...
     * @param total_engle
     */
    public void setTotal_engle(float total_engle) {
        this.sweepAngle = total_engle;
    }
